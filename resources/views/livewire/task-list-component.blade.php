            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        ...
                        <button wire:click="filterByStatus('in-progress')" class="bg-yellow-500 text-white px-4 py-2 rounded">In Progress</button>
                        <button wire:click="filterByStatus('done')" class="bg-green-500 text-white px-4 py-2 rounded">Done</button>
                    </div>
                                    ...
                                    @foreach ($taskLists as $taskList)
                                        <tr wire:key="{{ $taskList->id }}">
                                            ...
                                            @if ($taskList->status == 'done')
                                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-sm font-medium sm:pr-0">
                                                    {{-- <a href="{{ route('task-edit', $taskList->id) }}" wire:navigate class="text-gray-500 hover:text-gray-900">Archived</a> --}}
